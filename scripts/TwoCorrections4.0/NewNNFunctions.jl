...
function plot_metric_components(parameters, r_min, r_max)
    ...
    for r in r_values
        ...
        a1, a2, a3 = output[2], output[3], output[4]
        ...
        push!(f_rr_predicted, max(rr_correction, 0.05))
    end
...
function Newtonian(du, u, model_params, t;
    ...
    function H(state_vec)
        ...
        if isnothing(NN)
            ...
            a1, a2, a3 = conservative_corrections[2], conservative_corrections[3], conservative_corrections[4]
            ...
            f_rr_NN_correction = max(rr_correction, 0.05)

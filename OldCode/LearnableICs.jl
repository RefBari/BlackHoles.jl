...
x_ecc, y_ecc = file2trajectory(tsteps,"input/trajectoryA_Schwarzschild_p40_e0p3.txt")
x2_ecc, y2_ecc = file2trajectory(tsteps,"input/trajectoryB_Schwarzschild_p40_e0p3.txt")
waveform_real_ecc = file2waveform(tsteps,"input/waveform_real_Schwarzschild_p40_e0p3.txt")

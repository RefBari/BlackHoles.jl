...
plot(x_samples[:], y_samples[:], label="data", seriestype=:scatter)
...
plot!(x_samples[:], y_initial_prediction[:], label="initial prediction", seriestype=:scatter)
...
for epoch in 1:N_EPOCHS
    print(pullback(loss_fn, parameters, layer_states))

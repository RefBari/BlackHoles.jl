...
function GENERIC_Schwarzschild(du, u, model_params, t;
    ...
    function H(state_vec::AbstractVector)
        ...
        f_ϕϕ_NN_correction = sigmoid(conservative_corrections[2])
...
function GENERIC_Newtonian(du, u, model_params, t;
    ...
    # f_tt_NN_correction = exp(conservative_corrections[1])
    f_rr_NN_correction = -1e-1 * sigmoid(conservative_corrections[1])
    f_ϕϕ_NN_correction = 1e-1 * sigmoid(conservative_corrections[2])
    # print(f_tt_NN_correction)
